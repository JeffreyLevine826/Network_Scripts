# -*- coding: utf-8 -*-
"""
Created on Mon Jan 29 09:33:13 2024
...
def ping():
    ...
    try:
        ...
        # send connection request to defined server
...
def main():
    ...
    with open(FILE, "a") as file:
        # write into the file as a into networkinginfo.log,
    ...
    while True:
        ...
        if ping():
            ...
            down_time = calculate(down_time, up_time)
